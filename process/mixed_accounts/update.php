...
// Check permission to edit mixed account
if (!hasPermission('edit_mixed_account')) {
    echo json_encode(['success' => false, 'message' => 'ڕێگەپێدانی ناتەواو. تۆ ناتوانیت دەستکاری حسابی تێکەڵاو بکەیت.']);
    exit();
}
...
try {
    ...
    // Update mixed account
    $sql = "UPDATE mixed_accounts SET 
            name = :name, 
            phone1 = :phone1, 
            phone2 = :phone2, 
            ...
            they_owe = :they_owe,
            we_owe = :we_owe, 
            they_advance = :they_advance,
            we_advance = :we_advance,
            city = :city, 
            location = :location, 
            notes = :notes 
            WHERE id = :id";
    ...
    echo json_encode(['success' => true, 'message' => 'حساب بە سەرکەوتوویی نوێ کرایەوە']);
